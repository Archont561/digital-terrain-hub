...
test.describe.serial('Workspace Actions', () => {
  ...
  test('createWorkspace – success', async ({ astroActions }) => {
    const result = await astroActions.expectSuccess<z.infer<typeof WorkspaceResponse>>(
      'createWorkspace',
      {
  ...
  test('createWorkspace – validation error (name too long)', async ({ astroActions }) => {
    const error = await astroActions.expectValidationError('createWorkspace', {
  ...
  test('getWorkspace – validation error (invalid uuid)', async ({ astroActions }) => {
  ...
  test('getWorkspace – validation error (missing uuid)', async ({ astroActions }) => {
    const error = await astroActions.expectValidationError('getWorkspace', {});
  ...
  test('updateWorkspace – validation error (invalid uuid)', async ({ astroActions }) => {
    const error = await astroActions.expectValidationError('updateWorkspace', {
      uuid: 'invalid-uuid',
      payload: {
        name: 'Updated name',
      },
  ...
  test('deleteWorkspace – validation error (invalid uuid)', async ({ astroActions }) => {
    const error = await astroActions.expectValidationError('deleteWorkspace', {
      uuid: 'not-valid',
    });
  ...
  test('listWorkspaces – success (no filters)', async ({ astroActions }) => {
    const result = await astroActions.expectSuccess<z.infer<typeof WorkspaceListResponse>>(
      'listWorkspaces',
      undefined
    );
