...
test.describe.serial("WorkspaceTableRow", () => {
  ...
  test.describe("Rendering", () => {
    test("renders in normal mode with correct initial data", async ({ workspaceTableRow }) => {
    ...
    test("edit button has correct href", async ({ workspaceTableRow, page }) => {
      ...
      await test.step("Verify edit button href", async () => {
        await expect(workspaceTableRow.editBtn).toHaveAttribute("href", expectedUrl);
      });
  ...
  test.describe("Edit Mode", () => {
    test("switches to edit mode and focuses input", async ({ workspaceTableRow }) => {
    ...
    test("cancel: reverts to normal mode on click away", async ({ workspaceTableRow }) => {
      await test.step("Enter edit mode", async () => {
        await workspaceTableRow.enterEdit();
      });
    ...
    test("success: updates name via API and UI", async ({ workspaceTableRow, ctx }) => {
    ...
    test("validation: shows error on empty name", async ({ workspaceTableRow, toast }) => {
    ...
    test("error: handles API failure gracefully", async ({ workspaceTableRow, ctx, toast }) => {
  ...
  test.describe("Delete", () => {
    test("success: removes row from DOM", async ({ workspaceTableRow, ctx }) => {
    ...
    test("error: shows toast and keeps row", async ({ workspaceTableRow, ctx, toast }) => {
